@(set '(=)||' <# lean and mean cmd / ps1 hybrid, can paste into powershell console https://discord.com/channels/746721520931569757/1105603509820325889/1216168631394897960 #> @'
